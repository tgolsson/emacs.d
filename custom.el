   ...
   (quote
    ((eval face-remap-add-relative
     ...
     (eval face-remap-add-relative
           (quote org-block)
           (quote
            (:familys "Fira Mono for Powerline" :height 100)))
